...
function check(changes, observer) {
    if(document.getElementById("page-init-data")) {
        observer.disconnect();
        // actions to perform after #mySelector is found
        
        let script = document.getElementById("page-init-data")
...
function check2(changes,observer){
    if (site.socket){
        ...
        function go_move(best_move){
            setTimeout(()=>{
                site.socket.send("move",{b:1,u:best_move},{sign: site.socket._sign, ackable: true, withLag: false, millis: 4611.5})
        ...
        site.socket.ws.addEventListener("open", (e)=>{
        ...
        site.socket.ws.addEventListener("message", (e) => {
